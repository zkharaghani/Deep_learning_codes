...
def load_happy_dataset():
    train_dataset = h5py.File('datasets/train_happy.h5', "r")  # Read the dataset train_happy.h5
...
def random_mini_batches(X, Y, mini_batch_size=64, seed=0):
    ...
    # The number of mini batches of size mini_batch_size in your partitionning
